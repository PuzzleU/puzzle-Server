package com.PuzzleU.Server.upload.service;
...
public class UploadService {
    ...
    public ResponseEntity<String> uploadSkillset(MultipartFile file, String skillsetName) {
    ...
    public ResponseEntity<String> uploadCompetition (
            UploadCompetitionDto uploadCompetitionDto
    ) {
        try {
